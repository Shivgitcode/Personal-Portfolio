...
export default function SkillCard({ el }) {
  return (
    <div className="flex flex-col items-center justify-between max-w-[400px] px-[36px] py-[10px] rounded-[16px] bg-[#171721] border-[1px] border-[#854CE6] bg-shadow lg:min-w-[500px] lg:min-h-[360px] lg:justify-start">
